...
//	te.test22();
	...
	public void test24() {
		...
		do {
			System.out.println("가위바위보중 한개를 입력학시오");
			...
			System.out.println("컴퓨터는"+ computer +"를냈습니다");
			
			
			if(computer==input) {
				System.out.println("비겼습니다 다시시작");
	...
	public void test22() {
		...
		for(;;) {
			System.out.println("2보다 큰 정수를 입력하시오");
			int num = sc.nextInt();//입력받은정수
	...
	public void test21() {
		...
		System.out.println("1~100 정수한개를 입력하시오");
		
		int count = 1;
		int randomnum = rd.nextInt(100)+1; //컴퓨터가 만들어낸 값
		int result = 0;
		
		for(;;) { 
			int num = sc.nextInt(); //당신이입력한 값
		 ...
		 System.out.println("당신이 입력한값 : " +result+"\n"+
				 			"난수 값 : "+randomnum);
	...
	public void test20() {
		...
		System.out.println("정수한개를 입력하시오");
		int num1 = sc.nextInt();
		System.out.println("정수한개를 또 입력하시오");
		int num2 = sc.nextInt();
		...
		} System.out.println("두개 중 작은 값에서 큰값까지 홀수끼리의 곱은"+result);
	...
	public void test19() {
		...
		System.out.println("1부터"+num+"까지의 홀수의 곱은"+result);
	...
	public void test18() {
		...
		System.out.println("찾고자 하는 알파벳 입력하시오");
		char alphabet = sc.next().charAt(0);

		if (alphabet >= 'A' && alphabet <= 'Z' || alphabet >= 'a' && alphabet <= 'z') {

			int cnt = 0;
			for (int a = 0; a < menu.length(); a++) { // 여기를 가동해라 for만큼

				char c = menu.charAt(a);
				if (c == alphabet) {
					cnt++;
				}

			}
			System.out.println(alphabet + "의갯수는" + cnt + "개");

		} else {
			System.out.println("영문자가 아닙니다" + "문자를 잘못 입력하셨습니다");

		}

	}

	public void test17() { // 구구단
	...
	public void test16() {
		...
		System.out.println(num + "까지 짝수의 합은" + result + "입니다");
	...
	public void test13() {
		...
		do {
			...
			case 1:
				...
				break;
			case 2:
				System.out.println("김밥는 2000원입니다.");
				break;
			case 3:
				System.out.println("오댕는 1000원입니다.");
				break;
			case 4:
				System.out.println("순대는 2000원입니다.");
				break;
			case 5:
				System.out.println("튀김 3000원입니다.");
				break;
			case 6:
